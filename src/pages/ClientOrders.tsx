...
import { ArrowLeft, Eye, User, Phone, MapPin, Search } from "lucide-react";
                        ...
                        {estimatedMode ? (
                          <>
                            <div className="flex justify-between">
                              ...
                              <span className="text-foreground font-medium">Rs. {(order.estimatedAmount || 0).toLocaleString('en-IN')}</span>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-muted-foreground">Estimated Weight:</span>
                              <span className="text-foreground font-medium">{formatWeight(order.estimatedWeight || 0)}</span>
                            </div>
                          </>
                        ) : (
                          <>
                            <div className="flex justify-between">
                              ...
                              <span className="text-foreground font-medium">Rs. {order.totalAmount?.toLocaleString() || 0}</span>
                            </div>
                            <div className="flex justify-between">
